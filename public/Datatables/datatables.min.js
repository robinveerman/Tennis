...
(function (h) {
    ...
    function qb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures,
            g = '<input type="search" class="form-control" placeholder="Zoeken..."/>', j = d.sSearch,
            ...
            i = h("input", b).val(e.sSearch).attr("placeholder", 'Zoeken...').on("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Oa(f, g) : f).on("keypress.DT", function (a) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "Eerste", sLast: "Laatste", sNext: "Volgende <i class=\"fas fa-chevron-right\"></i>", sPrevious: "<i class='fas fa-chevron-left'></i> Vorige"},
            sEmptyTable: "No data available in table",
            sInfo: "Toont _START_ - _END_ van _TOTAL_ resultaten",
            sInfoEmpty: "Toont 0 van de 0 van 0 retultaten",
